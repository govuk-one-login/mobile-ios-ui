...
struct ColorTests {
    ...
    @Test func test_Color_Green6() async throws {
        let expectedColor = UIColor.fromHex("#02A458")
    ...
    @Test func test_Color_Green10() async throws {
        let expectedColor = UIColor.fromHex("#66F39E")
        
        let sut = DesignSystem.Color.Base.green10
        #expect(sut.cgColor == expectedColor.cgColor)
    }
    ...
    @Test func test_Color_Teal() async throws {
        ...
        let sut = DesignSystem.Color.Base.teal1
        #expect(sut.cgColor == expectedColor.cgColor)
    }
    
    @Test func test_Color_Grey1() async throws {
        let expectedColor = UIColor.fromHex("#505A5F")
    ...
    @Test func test_Color_Grey7() async throws {
        let expectedColor = UIColor.fromHex("#E7E6E5")
        
        let sut = DesignSystem.Color.Base.grey7
        #expect(sut.cgColor == expectedColor.cgColor)
    }
    
    @Test func test_Color_Grey8() async throws {
        let expectedColor = UIColor.fromHex("#CECECE")
        
        let sut = DesignSystem.Color.Base.grey8
        #expect(sut.cgColor == expectedColor.cgColor)
    }
    ...
    @Test func test_Color_Red5() async throws {
        let expectedColor = UIColor.fromHex("#CC544E")
        
        let sut = DesignSystem.Color.Base.red5
        #expect(sut.cgColor == expectedColor.cgColor)
    }
